...
export const positioningStatement =
  "Zekarias Asaminew is a software engineer specializing in agentic AI and LLM tooling: LangChain, LangGraph, RAG pipelines, the OpenAI/GPT-4o API, vector databases, and autonomous agents. He is a Computer Science and Bioinformatics student at Augustana College (graduating Dec 2026). He's a part-time Software Engineer at John Deere, where he built an agentic pipeline that traces production alerts back to the responsible git commit and opens a draft PR fix, and interned as a Tax Technology & Transformation Intern at EY in summer 2026. He was the most-credited external contributor in GitHub Desktop's v3.5.4 release changelog (three shipped fixes, including adding Copilot commit-message generation to the context menu) and has a merged compiler fix in React. He is open to new opportunities.";
